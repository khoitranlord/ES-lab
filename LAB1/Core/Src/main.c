...
//  }
  ...
  /* USER CODE END WHILE */
  	 ...
  	 case INIT:
  		 ...
  		 HAL_GPIO_WritePin ( DEBUG_LED_GPIO_Port , OUTPUT_Y1_Pin , 0) ;
  		 HAL_GPIO_WritePin ( DEBUG_LED_GPIO_Port , OUTPUT_Y0_Pin , 0) ;
  		 state = RED;
  		 break;
  	 case RED:
  	 ...
  	 case YELLOW:
  		 HAL_GPIO_WritePin ( DEBUG_LED_GPIO_Port , DEBUG_LED_Pin , 0) ;
  		 HAL_GPIO_WritePin ( DEBUG_LED_GPIO_Port , OUTPUT_Y1_Pin , 1) ;
  		 HAL_GPIO_WritePin ( DEBUG_LED_GPIO_Port , OUTPUT_Y0_Pin , 0) ;
  		 if(count<0) {
  			 count = 1;
  			 state = GREEN;
  	 ...
  	 case GREEN:
  		 HAL_GPIO_WritePin ( DEBUG_LED_GPIO_Port , DEBUG_LED_Pin , 0) ;
  		 HAL_GPIO_WritePin ( DEBUG_LED_GPIO_Port , OUTPUT_Y1_Pin , 0) ;
  		 HAL_GPIO_WritePin ( DEBUG_LED_GPIO_Port , OUTPUT_Y0_Pin , 1) ;
  		 if(count<0) {
  			 count = 5;
  			 state = RED;
  		 }
